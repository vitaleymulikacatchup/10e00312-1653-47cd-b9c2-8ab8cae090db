...
export const metadata: Metadata = {
  title: "Sailing Around The World - Blue-Water Navigation & Community",
  description: "Connect with fellow sailors, discover proven ocean routes, find reliable marina services, and join exclusive sailing events. Your gateway to blue-water adventures.",
  keywords: "blue-water sailing, ocean routes, marina services, sailing community, yacht navigation, sailing events, circumnavigation, sailing guides",
  openGraph: {
    title: "Sailing Around The World - Blue-Water Navigation & Community",
    description: "Connect with fellow sailors, discover proven ocean routes, find reliable marina services, and join exclusive sailing events worldwide.",
    siteName: "Sailing Around The World",
    type: "website"
  },
  twitter: {
